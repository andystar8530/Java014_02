...
<head>
    ...
    <style>
          .opa{opacity: 0.6;}
          .bgcolor{background-color:#FFE4E1;}
    </style>    
      ...
      <body class=" bgcolor">
       <jsp:include page="/fragment/topMVC.jsp" />
        ...
        <main role="main" class="container">
          ...
          <c:forEach var="atitle" items="${atitle}">
