	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-3 mb-4">
				<div class="list-group">
					<div class="list-group-item href="#" >
						<img src="../data/Image/duck.jpg" width="80"
							style="border-radius: 50%;" id="partner-icon">
						<div>會員-可達鴨</div>
					...
					<a href="#" class="list-group-item"><img
						...
						class="list-group-item"><img
							src="../data/icon/3253474-wedding/png/015-picture.png">我的婚禮</a>
						...
						<a class="list-group-item"><img
							...
							src="../data/icon/3253474-wedding/png/001-clipboard.png">我的討論區

					</a> <a class="list-group-item list-group-2"><img
							src="../data/icon/3253474-wedding/png/027-wedding invitation.png">我的收藏
							> </a> <a class="list-group-item" href="../"><img
			...
			<div class="col-lg-9 mb-4">
				<h2>基本資料&nbsp</h2>
				<a href="newlywedInfo.jsp"><img src="../data/icon/document.png"
					width="30" class="editInfo"></a>
				<div class="newlyWed">Email(信箱)</div>
				<div class="newlyWed">手機號碼</div>
				<div class="newlyWed">真實姓名</div>
				<div class="newlyWed">聯絡時間</div>
